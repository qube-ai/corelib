...
void performOTAUpdate(String version)
{
    ...
    if (client.connect(host.c_str(), 80))
    {
        ...
        /*
            HTTP/1.1 200 OK
            X-GUploader-UploadID: ABg5-UxcEyzU5lPixHuyElJO_tWYg07KwjBSp5mcrapeeG2FviDUmsHYDmKP7cPTsJMH6Y9BizGpA9AcVGnGGu6DVpI
    ...
    {
        Serial.println("Connection to " + host + " failed. Please check your network.");
    }
